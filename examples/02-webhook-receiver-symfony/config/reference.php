 ...
 *     }>,
 * }
 * @psalm-type GandoPartnerConfig = array{
 *     api_key?: scalar|Param|null, // Partner API key (gando_pk_…).
 *     base_url?: scalar|Param|null, // Gando API base URL. // Default: "https://gando.app"
 *     connect?: array{
 *         secret?: scalar|Param|null, // Connect signing secret (gando_cs_…). // Default: null
 *         partner_slug?: scalar|Param|null, // Partner slug used in connect URLs. // Default: null
 *         base_url?: scalar|Param|null, // Default: "https://dashboard.gando.app"
 *     },
 *     webhooks?: array{
 *         secret?: scalar|Param|null, // Webhook signing secret (gando_whsec_…). // Default: null
 *         tolerance_seconds?: int|Param, // Default: 300
 *         path?: scalar|Param|null, // Default route path for the bundled GandoWebhookController. // Default: "/webhooks/gando"
 *         dedup_ttl_seconds?: int|Param, // How long to remember processed webhook bodies (requires cache.app). // Default: 86400
 *     },
 * }
 ...
 *     gando_partner?: GandoPartnerConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
